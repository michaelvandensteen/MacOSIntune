...
############################################################################################
##
## Script to rename a Mac based on Serial Number
##
############################################################################################

## original script: https://github.com/microsoft/shell-intune-samples/blob/master/macOS/Config/DeviceRename/DeviceRename2.sh
## Adapted to only use Serial Number
